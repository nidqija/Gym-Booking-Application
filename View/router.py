...
from Patterns.Decorator.booking_qr_decorator import BookingQRDecorator
...
async def generate_qr(request: Request, booking_id: str, current_user = Depends(get_current_user)):
    ...
    qr_decorator = BookingQRDecorator(booking)
    qr_code = await qr_decorator.generate_qr_code()
